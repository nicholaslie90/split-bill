...
// 4h. What Gemini hands back. It is the only reader there is, and it is still
// untrusted input deciding what everybody pays, so the shape, the range and the
// characters all get checked before any of it becomes an item.
{
