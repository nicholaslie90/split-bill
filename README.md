...
- **The bar** carries the bill you are in: a picker with every bill on it — switching is one tap, not a scroll to the foot of the page — plus **+ New bill** at the end of the list, and a **Clear** button that empties the open bill and starts fresh without touching any of the others.
